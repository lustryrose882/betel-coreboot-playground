...
#define BIOS_CHARACTERISTICS_VL_MESA		(1 << 13)
...
#define BIOS_CHARACTERISTICS_NEC9800		(1 << 20)
#define BIOS_CHARACTERISTICS_TOSHIBA360RPM	(1 << 21)
#define BIOS_CHARACTERISTICS_5_25_360KB_FLOPPY	(1 << 22)
#define BIOS_CHARACTERISTICS_5_25_1200KB_FLOPPY	(1 << 23)
#define BIOS_CHARACTERISTICS_3_5_720KB_FLOPPY	(1 << 24)
#define BIOS_CHARACTERISTICS_3_5_2880KB_FLOPPY	(1 << 25)
#define BIOS_CHARACTERISTICS_PRTSC_SERVICE	(1 << 26)
#define BIOS_CHARACTERISTICS_8042_KEYBOARD	(1 << 27)
#define BIOS_CHARACTERISTICS_SERIAL_SERVICE	(1 << 28)
#define BIOS_CHARACTERISTICS_PRINTER_SERVICE	(1 << 29)
#define BIOS_CHARACTERISTICS_CGA_MONO_VIDEO	(1 << 30)
#define BIOS_CHARACTERISTICS_NES_PC_98		(1 << 31)
...
#define BIOS_EXT1_CHARACTERISTICS_LS120_BOOT	(1 << 4)
#define BIOS_EXT1_CHARACTERISTICS_ATAPI_ZIP_BOOT	(1 << 5)
...
#define BIOS_EXT2_CHARACTERISTICS_FNKEY_NETWORK	(1 << 1)
#define BIOS_EXT2_CHARACTERISTICS_TARGET	(1 << 2)
#define BIOS_EXT2_CHARACTERISTICS_UEFI		(1 << 3)
#define BIOS_EXT2_CHARACTERISTICS_VM		(1 << 4)
